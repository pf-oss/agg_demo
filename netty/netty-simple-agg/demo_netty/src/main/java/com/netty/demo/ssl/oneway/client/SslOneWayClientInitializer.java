package com.netty.demo.ssl.oneway.client;
...
public class SslOneWayClientInitializer extends ChannelInitializer<SocketChannel> {
	...
	protected void initChannel(SocketChannel ch) throws Exception {
		...
		String cChatPath = "E:/20200323/demo/demo_netty_one/src/main/java/com/netty/demo/demo_netty_one/ssl/config/oneway/clientStore.jks";
