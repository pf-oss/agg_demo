...
import com.netty.demo.ssl.oneway.client.SslOneWayContextFactory;
...
public class SslOneWayServerInitializer extends ChannelInitializer<SocketChannel> {
	...
	protected void initChannel(SocketChannel sc) throws Exception {
		...
		String sChatPath = "E:/20200323/demo/demo_netty_one/src/main/java/com/netty/demo/demo_netty_one/ssl/config/oneway/serverStore.jks";
