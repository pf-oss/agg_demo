package com.kafka.demo.kafka_springboot.simple;
...
public class ConsumerMain {
    ...
    private static Consumer<String, String> createConsumer() {
        ...
        // 设置 Broker 的地址
        properties.put("bootstrap.servers", "192.168.177.128:9092");
        // 消费者分组
        properties.put("group.id", "demo-consume-group");
        // 设置消费者分组最初的消费进度为 earliest 。可参考博客 https://blog.csdn
